...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'galaxyline.nvim', 'nvim-toggleterm.lua', 'telescope-project.nvim', 'barbar.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
