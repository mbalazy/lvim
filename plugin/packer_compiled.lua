...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    config = { "\27LJ\2\nj\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\25auto_restore_enabled\2\22auto_save_enabled\1\nsetup\17auto-session\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'dashboard-nvim', 'galaxyline.nvim', 'barbar.nvim', 'telescope-project.nvim', 'nvim-toggleterm.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
