...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'galaxyline.nvim', 'nvim-toggleterm.lua', 'telescope-project.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
