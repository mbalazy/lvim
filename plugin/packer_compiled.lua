...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dashboard-nvim', 'barbar.nvim', 'nvim-toggleterm.lua', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
