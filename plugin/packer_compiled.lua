...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'galaxyline.nvim', 'nvim-toggleterm.lua', 'barbar.nvim', 'telescope-project.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
