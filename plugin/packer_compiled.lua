...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'telescope-project.nvim', 'which-key.nvim', 'barbar.nvim', 'nvim-toggleterm.lua', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
